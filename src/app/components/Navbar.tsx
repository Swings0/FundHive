      ...
      <div className="flex justify-between lg:px-[2rem] px-[1rem] py-4 w-full fixed z-50 top-0 left-0">
        ...
        <ul
          className={`lg:flex static ${
            isOpen
              ? "flex flex-col py-8 opacity-100 visible translate-y-0"
              : "hidden"
          } lg:flex-row lg:items-center absolute lg:static top-full left-4 rounded-lg w-full lg:w-auto bg-slate-900 lg:bg-transparent lg:gap-4 p-4 lg:p-0 text-white lg:text-sm text-xs gap-1`}
        >
          <span className="text-slate-900 absolute bottom-[193px] font-bold right-12 text-3xl">
            !
          </span>
          <li
